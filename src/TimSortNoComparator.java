...
class TimSortNoComparator {
     ...
     */
    private TimSortNoComparator(int[] a, int[] work, int workBase, int workLen) {
        this.a = a;
     ...
     * @since 1.8
     */
    static <T> void sort(int[] a, int lo, int hi, int[] work, int workBase, int workLen) {
         ...
         */
        TimSortNoComparator ts = new TimSortNoComparator(a, work, workBase, workLen);
    ...
    private int[] ensureCapacity(int minCapacity) {
        if (tmpLen < minCapacity) {
            ...
            @SuppressWarnings({"unchecked", "UnnecessaryLocalVariable"})
            int[] newArray = (int[]) Array.newInstance
