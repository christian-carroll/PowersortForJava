...
class TimSortAlter <T> {
     ...
     */
    private TimSortAlter(T[] a, Comparator<? super T> c, T[] work, int workBase, int workLen) {
        this.a = a;
        this.c = c;
    ...
    static <T> void sort(T[] a, int lo, int hi, Comparator<? super T> c,
         ...
         */
        TimSortAlter ts = new TimSortAlter(a, c, work, workBase, workLen);
